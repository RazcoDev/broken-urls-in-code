...
const node_fetch_1 = __importDefault(__nccwpck_require__(1557));
function checkUrls(urls) {
    return __awaiter(this, void 0, void 0, function* () {
        const checkResults = [];
        for (const url of urls) {
            checkResults.push(yield checkUrl(url));
        }
        return checkResults;
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.findUrlsInFiles = void 0;
const fs = __importStar(__nccwpck_require__(7147));
const path = __importStar(__nccwpck_require__(1017));
const glob_1 = __nccwpck_require__(3277);
const core = __importStar(__nccwpck_require__(2186));
function findUrlsInFiles(directory, urlRegex, filesGlob) {
    return __awaiter(this, void 0, void 0, function* () {
        const urlsInFiles = [];
        // print cwd
        ...
        const files = yield (0, glob_1.glob)(fullPath, { ignore: 'node_modules/**' });
        for (const file of files) {
            // Read file content
            core.info(`Reading file: ${file}`);
            const content = yield fs.promises.readFile(file, 'utf-8');
...
exports.findUrlsInFiles = findUrlsInFiles;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const findUrls_1 = __nccwpck_require__(8632);
const checkUrls_1 = __nccwpck_require__(1754);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const brokenUrls = checkResults.filter(result => result.status >= 400 || result.error !== '');
